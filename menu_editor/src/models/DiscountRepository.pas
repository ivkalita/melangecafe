...
type
	...
	public
		...
		class procedure GenerateDiscounts(ABaseName: string; ADiscountBlock: TDiscountSeriaBlock);
	end;
...
{ TDiscountRepository }
	...
	class procedure TDiscountRepository.GenerateDiscounts(ABaseName: string;
		ADiscountBlock: TDiscountSeriaBlock);
	var
		adc: TDBCompsAddit;
		i: integer;
	begin
